...
def find_chains(player, length, (x, y), current, five):
    ...
    if board[x][y] == player:
        chain = hchain(length, (x, y), player, five)
        if chain != (-1, -1):
        ...
        chain = vchain(length, (x, y), player, five)
        if chain != (-1, -1):
            if five and chain < new:
                return chain
        ...
        chain = nwchain(length, (x, y), player, five)
        if chain != (-1, -1):
            if five and chain < new:
                return chain
        ...
        chain = swchain(length, (x, y), player, five)
        if chain != (-1, -1):
            if five and chain < new:
                return chain
